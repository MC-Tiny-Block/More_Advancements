#获得所有madv进度
    #minecraft标签页（基本不改）
    advancement grant @s only madv:story/get_crafting_table
    advancement grant @s only madv:story/get_wood
    advancement grant @s only madv:story/get_wooden_axe
    ...
    #Beta 1.0
        ...
        advancement grant @s only madv:mine/coal
        advancement grant @s only madv:mine/raw_copper
        advancement grant @s only madv:mine/raw_iron
        advancement grant @s only madv:mine/copper_ingot
        advancement grant @s only madv:mine/coal_block
        advancement grant @s only madv:mine/oxidized_copper
        advancement grant @s only madv:mine/copper_block
        advancement grant @s only madv:mine/torch
        advancement grant @s only madv:mine/into_darkness
        advancement grant @s only madv:mine/64_coal_blocks
        advancement grant @s only madv:mine/lapis_lazuli
        advancement grant @s only madv:mine/into_cave
        advancement grant @s only madv:mine/furnace
        advancement grant @s only madv:mine/raw_gold
        advancement grant @s only madv:mine/gold_ingot
        advancement grant @s only madv:mine/diamond_pickaxe
        advancement grant @s only madv:mine/on_the_deepist
        advancement grant @s only madv:mine/gravel
        advancement grant @s only madv:mine/flint
        advancement grant @s only madv:mine/in_gravel
        advancement grant @s only madv:mine/three_stone
        advancement grant @s only madv:mine/into_lava
        advancement grant @s only madv:mine/amethyst_shard
        advancement grant @s only madv:mine/use_spyglass
        advancement grant @s only madv:mine/emerald
        advancement grant @s only madv:mine/iron_block
        advancement grant @s only madv:mine/64_iron_block
        advancement grant @s only madv:mine/blast_furnace
        advancement grant @s only madv:mine/64_diamond_block
        advancement grant @s only madv:mine/diamond_block
        advancement grant @s only madv:mine/64_cobblestone
        advancement grant @s only madv:mine/flint_and_steel
        advancement grant @s only madv:mine/into_deep_nether
        advancement grant @s only madv:mine/quartz
        advancement grant @s only madv:mine/eat_rotten_flesh
        advancement grant @s only madv:mine/netherite_ingot
        advancement grant @s only madv:mine/netherite_block
        advancement grant @s only madv:mine/gold_block
        advancement grant @s only madv:mine/64_gold_block
        advancement grant @s only madv:mine/clock
        advancement grant @s only madv:mine/tuff
        advancement grant @s only madv:mine/cobbled_deepslate
        advancement grant @s only madv:mine/use_bone_meal_on_moss_block
        advancement grant @s only madv:mine/eat_glow_berries
        advancement grant @s only madv:mine/use_bone_meal_on_azalea
        advancement grant @s only madv:mine/to_deep_dark
        advancement grant @s only madv:mine/to_ancient_city
        advancement grant @s only madv:mine/in_cobweb
        advancement grant @s only madv:mine/echo_shard
        advancement grant @s only madv:mine/get_darkness
        advancement grant @s only madv:mine/destory_tools
        advancement grant @s only madv:mine/kill_bat
        advancement grant @s only madv:mine/raw_mineral_block
        advancement grant @s only madv:mine/pointed_dripstone
        advancement grant @s only madv:mine/skeleton_damage
        advancement grant @s only madv:mine/kill_silverfish
        advancement grant @s only madv:mine/all_rock
        advancement grant @s only madv:mine/fill_bucket_with_water
        advancement grant @s only madv:mine/landing_water
        advancement grant @s only madv:mine/chest_in_ice_room
        advancement grant @s only madv:mine/glow_lichen
        advancement grant @s only madv:mine/jump_off_50b
        advancement grant @s only madv:mine/chest_in_dungeon
        advancement grant @s only madv:mine/disc_5
        advancement grant @s only madv:mine/sparking
        advancement grant @s only madv:mine/iron_nugget
        advancement grant @s only madv:mine/in_deep_badlands
        advancement grant @s only madv:mine/stone_tools
        advancement grant @s only madv:mine/compass
        advancement grant @s only madv:mine/sculk_blocks
        advancement grant @s only madv:mine/all_ores
        advancement grant @s only madv:mine/diamonds_to_you
        advancement grant @a only madv:mine/lapis_block
        ...
        advancement grant @s only madv:monsters_and_combat/atk_smite_axe
        advancement grant @s only madv:monsters_and_combat/atk_stone_axe
        advancement grant @s only madv:monsters_and_combat/kill_creeper
        advancement grant @s only madv:monsters_and_combat/kill_skeleton
        advancement grant @s only madv:monsters_and_combat/kill_zombie
    ...
    #Beta 1.0.1
        ...
        advancement grant @s only madv:monsters_and_combat/kill_all_skeleton
        advancement grant @s only madv:monsters_and_combat/kill_cave_spider
        advancement grant @s only madv:monsters_and_combat/buy_trial_map
        advancement grant @s only madv:monsters_and_combat/deflect_creeper
        advancement grant @s only madv:monsters_and_combat/hurt_by_creeper
        advancement grant @s only madv:monsters_and_combat/fire_creeper
        advancement grant @s only madv:monsters_and_combat/atk_netherite_sword
        advancement grant @s only madv:monsters_and_combat/kill_slime
        advancement grant @s only madv:monsters_and_combat/kill_witch
        advancement grant @s only madv:monsters_and_combat/kill_enderman
        advancement grant @s only madv:monsters_and_combat/kill_pillager
        advancement grant @s only madv:monsters_and_combat/kill_vindicator
        advancement grant @s only madv:monsters_and_combat/kill_evoker
        advancement grant @s only madv:monsters_and_combat/kill_vex
